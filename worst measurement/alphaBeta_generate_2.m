function  [nodenext,GraphUpadte,BestValue,done]=alphaBeta_generate_2(Count,GraphName,End_Generation,Max_Children, Min_Children,y)%genearate the next node by deepth first
